...
/* harmony import */ var _start_chat_start_chat_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./start-chat/start-chat.component */ "./src/app/start-chat/start-chat.component.ts");
...
var routes = [
    ...
    { path: 'start/:username', component: _start_chat_start_chat_component__WEBPACK_IMPORTED_MODULE_3__["StartChatComponent"] },
...
/* harmony import */ var _start_chat_start_chat_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./start-chat/start-chat.component */ "./src/app/start-chat/start-chat.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _start_chat_start_chat_component__WEBPACK_IMPORTED_MODULE_7__["StartChatComponent"],
            ...
            providers: [_service_user_service__WEBPACK_IMPORTED_MODULE_9__["UserService"]],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _assets_js_System_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../assets/js/System.js */ "./src/assets/js/System.js");
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, userServ) {
        this.router = router;
        this.userServ = userServ;
        this.msgBox = 'form-message';
        this.system = new _assets_js_System_js__WEBPACK_IMPORTED_MODULE_1__["System"]();
        this.baseUri = 'start';
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        if (this.user.username.length < 6) {
            ...
            this.userServ.registerUser(this.user)
                ...
                _this.isUserAdded = true;
                _this.router.navigate([(_this.baseUri + '/' + user.username)]);
            }, function (err) { return _this.system.displayFormMessage(_this.msgBox, 'could not add user', 3); });
        }
    };
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.registerUser = function (user) {
        ...
        return this.http.post(serverUri + '/user/add', reqBody, headerOptions);
    };
...
/***/ "./src/app/start-chat/start-chat.component.css":
/*!*****************************************************!*\
  !*** ./src/app/start-chat/start-chat.component.css ***!
  \*****************************************************/
/*! no static exports found */
...
/***/ "./src/app/start-chat/start-chat.component.html":
/*!******************************************************!*\
  !*** ./src/app/start-chat/start-chat.component.html ***!
  \******************************************************/
/*! no static exports found */
...
/***/ "./src/app/start-chat/start-chat.component.ts":
/*!****************************************************!*\
  !*** ./src/app/start-chat/start-chat.component.ts ***!
  \****************************************************/
/*! exports provided: StartChatComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StartChatComponent", function() { return StartChatComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
...
var StartChatComponent = /** @class */ (function () {
    function StartChatComponent(route, router, userService) {
        this.route = route;
        this.router = router;
        this.userService = userService;
    }
    StartChatComponent.prototype.ngOnInit = function () {
        this.id = localStorage.getItem('_id');
    };
    StartChatComponent.prototype.getId = function () {
        return this.id;
    };
    StartChatComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-start-chat',
            template: __webpack_require__(/*! ./start-chat.component.html */ "./src/app/start-chat/start-chat.component.html"),
            styles: [__webpack_require__(/*! ./start-chat.component.css */ "./src/app/start-chat/start-chat.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"],
            _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
            _service_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"]])
    ], StartChatComponent);
    return StartChatComponent;
}());
...
module.exports = __webpack_require__(/*! /var/www/html/anon-chat/ang-src/src/main.ts */"./src/main.ts");
